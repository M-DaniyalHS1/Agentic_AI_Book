...
export default {
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/agent-book-factory/agent-book-factory/tree/main/frontend/",
          "routeBasePath": "/"
        },
        "blog": false,
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 AI-Native Digital Textbook. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
